...
parser.add_argument('--delimiter', dest='delimiter', default=',', help='delimiter character. (default=,comma)')
...
parser.add_argument('--encoding', dest='encoding', default='cp932',
        help='character encoding (default=cp932)')
