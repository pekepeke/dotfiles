...
autoload -Uz peco-docker-id-insert-at-pos
...
autoload -Uz peco-git-recent-branches-all-insert-at-pos
...
autoload -Uz peco-git-recent-branches-insert-at-pos
zle -N peco-git-recent-branches-insert-at-pos
