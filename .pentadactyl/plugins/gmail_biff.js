...
(function(){
    ...
    var timeout = parseInt(liberator.globalVariables.gmbf_timeout || 1000);
    ...
    setTimeout(function() {
        try {
            ...
            var timerId = setTimeout(function(xhr) { xhr.abort(); liberator.echoerr("Gmail Biff: connection closed"); }, timeout, xhr);
            xhr.send(null);
