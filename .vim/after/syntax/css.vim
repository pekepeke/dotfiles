...
if has("gui_running") || &t_Co==256
   ...
   " http://stackoverflow.com/questions/1543676/using-css-color-plugin-for-vim-causes-omni-completion-not-to-work
   "autocmd CursorHold * silent call s:PreviewCSSColorInLine('.')
   "autocmd CursorHoldI * silent call s:PreviewCSSColorInLine('.')
   "set ut=100
   autocmd CursorHold * silent call s:PreviewCSSColorInLine('.') | call s:PreviewCSSColorInLine(line(".") - 1)
   autocmd CursorHoldI * silent call s:PreviewCSSColorInLine('.') | call s:PreviewCSSColorInLine(line(".") - 1)
   set ut=800
   "exe 'set ut=' . &timeoutlen
