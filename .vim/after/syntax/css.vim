...
if has("gui_running") || &t_Co==256
  ...
  function! s:preview_css_colors(...) range
    for i in range(a:0 ? a:1 : a:firstline, a:0 ? a:2 : a:lastline)
      call s:PreviewCSSColorInLine(i)
    endfor
  endfunction

  command! -range -buffer ColorPreview <line1>,<line2>call s:preview_css_colors()
  call s:preview_css_colors(1, line("$"))
