...
" Interface {{{1
function! operator#tabular#textile#new() "{{{2
  return s:instance.new()
endfunction

function! operator#tabular#textile#tabularize_tsv(motion_wiseness)
  return s:instance.new().tabularize_tsv(a:motion_wiseness)
endfunction

function! operator#tabular#textile#untabularize_tsv(motion_wiseness)
  return s:instance.new().untabularize_tsv(a:motion_wiseness)
endfunction

function! operator#tabular#textile#tabularize_csv(motion_wiseness)
  return s:instance.new().tabularize_csv(a:motion_wiseness)
endfunction

function! operator#tabular#textile#untabularize_csv(motion_wiseness)
