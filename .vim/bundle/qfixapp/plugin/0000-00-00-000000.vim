...
let g:QFixHowmMenuList = [
 \ '-------------------------------------',
 \ 'メニューの書き方',
 \ '普通のhowmファイルなので適当に編集して下さい。',
 \ '',
 \ 'ここにキーワードや、マクロアクション
 \ 、よく使うファイルなど、書いておくと便利です。',
...
let g:QFixHowmHelpList = [
 ...
 \ '  ,u       : クイックメモファイルを開く',
 \ '  ,<Space> : 日記を書く',
 \ '  ,j       : 現バッファのファイルと対になる ペアリンクhowmファイルを開く',
 \ '             (現バッファで qfixhowm.cpp を編集していた場合 qfixhowm.cpp.howmを開きます)',
 \ '',
 \ '  ,l       : 最近更新したエントリの検索(デフォルトでは過去5日間)',
 \ '  ,L       : 最近"作成"したエントリの検索(デフォルト検索日数は,lと共用)',
 \ '             実際にはhowmタイムスタンプの日付を検索する',
 \ '  ,m       : howmファイル専用のMRUリスト',
 \ '  ,rm      : howmのMRUリストから存在しないエントリを削除',
 \ '',
 \ '  ,s       : エントリを正規表現を使わないで検索',
 \ '  ,g       : エントリをgrep',
 \ '  ,\g      : エントリをgrepの設定にかかわらずvimgrep使用でgrep',
 \ '  ,a       : 過去エントリを全て検索',
 \ '  ,A       : ファイルリストを表示',
 \ '',
 \ '  ,hf      : 現バッファのファイル名をpコマンドで貼り付け可能なように無名レジスタに設定する',
 \ '             ファイル名は可能なら howm:// 形式に変換される',
 \ '  ,i       : サイドバーを開く',
 \ '  ,k       : 保存したQuickfixウィンドウを読み込む',
 \ '  ,rr      : ランダム表示',
 \ '  ,rR      : ランダム表示用のエントリリストファイルをリビルド',
 \ '  ,rk      : リンクキーワードファイルをリビルド',
 \ '',
 \ '== 予定・TODO (グローバル)',
 \ '',
 \ '  ,y       : 予定の表示',
 ...
 \ '  ,C       : 現在行の後に新規エントリを追加',
 \ '  ,n       : 現エントリの次に新規エントリを追加',
 \ '  ,N       : 現バッファの最後に新規エントリを追加',
 \ '  ,p       : 現エントリの前に新規エントリを追加',
 \ '  ,P       : 現バッファの先頭に新規エントリを追加',
 \ '',
 \ '  ,o       : アウトラインモード',
 \ '  ,rd      : 予定・TODOの定義行で実行すると、指定カウント分の予定・TODOに展開',
 \ '',
 \ '  ,S       : 現在位置のエントリの更新時刻を更新',
 \ '  ,W       : 一ファイル複数メモや連結表示を分割して保存。',
 \ '             ファイルは howm_dir へ作成される。',
 \ '  ,x       : 現在位置のエントリを削除',
 \ '  ,X       : 現在位置のエントリを新規ファイルへ移動',
 \ '  ,rs      : 現バッファのエントリをhowmタイムスタンプの新しい順番でソート',
 \ '  ,rS      : 現バッファのエントリをhowmタイムスタンプの古い順番でソート',
 \ '',
 \ '-------------------------------------',
 \ '= grepコマンド (グローバル)',
 \ '',
 ...
 \ '',
 \ '   @       : 表示中(選択中)のファイルを連結表示',
 \ '   &       : 表示中(選択中)のファイルをユーザーコマンドで変換',
 \ '             howm2html.vim(HTMLに変換表示)などの対応プラグインが必要',
 ...
 \ '',
 \ '==  繰り返し予定・TODOの展開',
 \ 'また繰り返し予定行で 3g,rdのようにコマンドを実行すると、単発予定に展開できます。',
 \ '']
